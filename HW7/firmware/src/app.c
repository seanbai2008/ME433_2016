...
//                    appData.xCoordinate = (int) (((float)(data[4])) * (2 / 32768.0));
//                    appData.yCoordinate = (int) ((float)(data[5]) * (2 / 32768.0));
            
                    appData.xCoordinate =(int8_t)(10*(float) (data[4]) * (2 / 32768.0));
                    appData.yCoordinate =(int8_t)(10*(float)(data[5]) * (2 / 32768.0));
                    vector ++;
                    movement_length = 0;
                }
            }
